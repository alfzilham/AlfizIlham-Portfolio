<section class="about-detail section-padding" id="about">
  <div class="container about-detail-inner">
    <div class="about-detail-left">
      <div class="about-avatar-wrapper">
        <img src="assets/image/avatars/about-avatar.webp" alt="Alfiz Ilham at desk" class="about-avatar" />
        <div class="about-stat-card stat-card-1">
          <span class="stat-big"><?= i18n::t('about_stat1_number') ?></span>
          <span class="stat-label"><?= i18n::t('about_stat1_label') ?></span>
        </div>
        <div class="about-stat-card stat-card-2">
          <span class="stat-big"><?= i18n::t('about_stat2_number') ?></span>
          <span class="stat-label"><?= i18n::t('about_stat2_label') ?></span>
        </div>
        <div class="about-role-pill"><?= i18n::t('about_role') ?></div>
      </div>
    </div>
    <div class="about-detail-right">
      <span class="eyebrow-pill"><?= i18n::t('about_eyebrow') ?></span>
      <h1 class="about-heading"><?= i18n::t('about_heading') ?></h1>
      <p class="about-description"><?= i18n::t('about_description') ?></p>
      <div class="about-ctas">
        <a href="#contact" class="btn btn-primary"><?= i18n::t('about_cta_primary') ?> <i data-lucide="external-link"></i></a>
        <a href="assets/cv/Alfiz_Ilham_CV.pdf" download class="btn btn-secondary"><i data-lucide="download"></i> <?= i18n::t('about_cta_secondary') ?></a>
      </div>
    </div>
  </div>
  <!-- Tech icon ticker -->
