  ...
  <div class="certificates-grid-wrap">
    <div class="certificates-grid">
      <div class="certificates-wheel-wrap">
        <div id="certOptionWheel" class="option-wheel" role="listbox" aria-label="Certificate list" tabindex="0"></div>
      </div>
      <div class="cert-carousel-wrap">
        <div id="certDepthCarousel" class="depth-carousel" role="group" aria-roledescription="carousel" aria-label="Certificate carousel" tabindex="0"></div>
      </div>
    </div>
  </div>
</section>
