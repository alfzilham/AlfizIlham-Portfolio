...
- **Feature highlights** below the grid: 2-column text layout separated by a thin top divider (matching the bio-stats divider language) — bold title + muted description per column ("Full-Stack + AI Built-In" · "Design & Calligraphy Craft"); stacks to 1 column on mobile
