...
- Feature highlights below the grid (2 columns, thin top divider): "Full-Stack + AI Built-In" · "Design & Calligraphy Craft" — bold title + muted description per column; stacks to 1 column on mobile
