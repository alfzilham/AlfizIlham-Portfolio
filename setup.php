...
// Seed Tools
$tools = [
    ['HTML', 'languages', 'Markup', 'assets/image/icons/fundamentals/html5.svg', 1],
    ['CSS', 'languages', 'Styling', 'assets/image/icons/fundamentals/css3.svg', 2],
    ['JavaScript', 'languages', 'Language', 'assets/image/icons/fundamentals/javascript.svg', 3],
    ['TypeScript', 'languages', 'Language', 'assets/image/icons/fundamentals/typescript.svg', 4],
    ['Python', 'languages', 'Language', 'assets/image/icons/fundamentals/python.svg', 5],
    ['C#', 'languages', 'Language', 'assets/image/icons/database/csharp.svg', 6],
    ['C', 'languages', 'Language', 'assets/image/icons/database/c.svg', 7],
    ['Sass', 'languages', 'Preprocessor', 'assets/image/icons/coding-tools/sass.svg', 8],
    ['React', 'frontend', 'Library', 'assets/image/icons/fundamentals/react.svg', 9],
    ['Next.js', 'frontend', 'Framework', 'assets/image/icons/fundamentals/nextjs.svg', 10],
    ['Tailwind CSS', 'frontend', 'Styling', 'assets/image/icons/fundamentals/tailwindcss.svg', 11],
    ['Redux', 'frontend', 'State Mgmt', 'assets/image/icons/coding-tools/redux.svg', 12],
    ['Bootstrap', 'frontend', 'Framework', 'assets/image/icons/coding-tools/bootstrap.svg', 13],
    ['jQuery', 'frontend', 'Library', 'assets/image/icons/coding-tools/jquery.svg', 14],
    ['D3.js', 'frontend', 'Visualization', 'assets/image/icons/coding-tools/d3.svg', 15],
    ['Node.js', 'backend-devops', 'Runtime', 'assets/image/icons/fundamentals/nodejs.svg', 16],
    ['Express', 'backend-devops', 'Framework', 'assets/image/icons/coding-tools/expressjs.svg', 17],
    ['MongoDB', 'backend-devops', 'Database', 'assets/image/icons/coding-tools/mongodb.svg', 18],
    ['Neon', 'backend-devops', 'Database', 'assets/image/icons/database/neon.svg', 19],
    ['GraphQL', 'backend-devops', 'API', 'assets/image/icons/coding-tools/graphql.svg', 20],
    ['Docker', 'backend-devops', 'Container', 'assets/image/icons/coding-tools/docker.svg', 21],
    ['Linux', 'backend-devops', 'Terminal', 'assets/image/icons/coding-tools/linux.svg', 22],
    ['Claude', 'ai-ml', 'AI Assistant', 'assets/image/icons/ai-productivity/claude.svg', 23],
    ['TensorFlow', 'ai-ml', 'ML Framework', 'assets/image/icons/ai-productivity/tensorflow.svg', 24],
    ['NumPy', 'ai-ml', 'Data Science', 'assets/image/icons/ai-productivity/numpy.svg', 25],
    ['Pandas', 'ai-ml', 'Data Analysis', 'assets/image/icons/ai-productivity/pandas.svg', 26],
    ['Scikit-learn', 'ai-ml', 'ML Library', 'assets/image/icons/ai-productivity/scikit-learn.svg', 27],
    ['AWS Bedrock', 'ai-ml', 'AI Platform', 'assets/image/icons/ai-productivity/aws-bedrock.svg', 28],
    ['Vertex AI', 'ai-ml', 'AI Platform', 'assets/image/icons/ai-productivity/vertex-ai.svg', 29],
    ['Canva', 'design', 'Graphic Design', 'assets/image/icons/design-tools/canva.svg', 30],
    ['CorelDRAW', 'design', 'Vector', 'assets/image/icons/design-tools/coreldraw.svg', 31],
    ['Lightroom', 'design', 'Photo Edit', 'assets/image/icons/design-tools/lightroom.svg', 32],
    ['Photoshop', 'design', 'Photo Edit', 'assets/image/icons/design-tools/photoshop.svg', 33],
    ['CalliPro', 'design', 'Calligraphy', 'assets/image/icons/design-tools/callipro.svg', 34],
    ['GitHub', 'tools-platform', 'Version Control', 'assets/image/icons/coding-tools/github.svg', 35],
    ['Codex', 'tools-platform', 'AI Coding', 'assets/image/icons/ai-productivity/codex.svg', 36],
    ['OpenCode', 'tools-platform', 'AI Coding', 'assets/image/icons/ai-productivity/opencode.svg', 37],
    ['Cursor', 'tools-platform', 'AI Coding', 'assets/image/icons/coding-tools/cursor.svg', 38],
    ['Trae', 'tools-platform', 'AI Coding', 'assets/image/icons/coding-tools/trae.svg', 39],
    ['Antigravity', 'tools-platform', 'AI Tool', 'assets/image/icons/coding-tools/antigravity.svg', 40],
    ['Obsidian', 'tools-platform', 'Note-taking', 'assets/image/icons/ai-productivity/obsidian.svg', 41],
    ['VS Code', 'tools-platform', 'Editor', 'assets/image/icons/coding-tools/visual-studio.svg', 42],
    ['Vercel', 'tools-platform', 'Deploy', 'assets/image/icons/deployment/vercel.svg', 43],
    ['Railway', 'tools-platform', 'Deploy', 'assets/image/icons/deployment/railway.svg', 44],
];
